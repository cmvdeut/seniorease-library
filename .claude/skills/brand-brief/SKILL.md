...
Look for `brand-brief.md` in this order (first match wins):

1. `./brand-brief.md` (project root — e.g. ShelfieEase BookTok MVP)
2. `tiktok-remotion/brand-brief.md` (SeniorEase Library)
3. `content/brand-brief.md` (optional shared content folder)
...
Save to the same location where you found an existing brief, or:

- **ShelfieEase** (`scripts/post-blotato.ts` at project root): `./brand-brief.md`
- **SeniorEase** (`tiktok-remotion/` folder): `tiktok-remotion/brand-brief.md`
- **Other projects**: `./brand-brief.md`
