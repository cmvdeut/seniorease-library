...
Check for `brand-brief.md` in: project root → `tiktok-remotion/brand-brief.md` → `content/brand-brief.md`. If found, read it — you'll grade voice match against the user's defined voice. If missing, skip the voice-match dimension and note it in the output.
